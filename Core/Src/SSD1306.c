...
uint8_t comm[]={ 
   ...
   0xA8,0x5F,        //Set Multiplex Ratio     1F - 128x32, 3F - 128x64
   ...
   0xD9,0xF1,        //Set Pre-Charge Period:  0x22 = VCC Supplied Externally, 0xF1 = VCC Generated by Internal
   
   0xDB,0x40,        //Set VCOMH De-select Level
...
const uint8_t font [][5] = 
{
   ...
   { 0x40, 0x40, 0x40, 0x40, 0x40 },   // ~ 0x7E 126 Replaced with underscore(0x5F)
